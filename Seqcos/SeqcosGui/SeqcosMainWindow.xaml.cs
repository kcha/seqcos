    ...
    public partial class SeqcosMainWindow : Window
    {
        ...
        private void OnRunQcAnalysisStarted(object sender, EventArgs e)
        {
            ...
            this.analysisThread.RunWorkerCompleted += delegate(object s, RunWorkerCompletedEventArgs args)
            {
                ...
                {
                    // Load results
                    LoadRunResults(application.FullOutputDirectory, this.application.FileList);
                }
            };
        ...
        private void LoadRunResults(string dir, Filenames fileList)
        {
            ...
            else
            {
                ...
                if (application != null)
                    OpenInExplorer(application.FullOutputDirectory);
            }
        ...
        private void UpdateInputStatistics(string csvFile)
        {
            ...
            this.readLengthMinValue.Text = stats.ReadLengthMin.ToString();
            this.readLengthValue.Text = stats.ReadLengthMax.ToString();
            this.readLengthMeanValue.Text = stats.ReadLengthMean.ToString();

            this.readGcContentMinValue.Text = stats.ReadGcContentMin.ToString();
            this.readGcContentMaxValue.Text = stats.ReadGcContentMax.ToString();
            this.readGcContentMeanValue.Text = stats.ReadGcContentMean.ToString();

            this.basePhredMinValue.Text = stats.BasePhredScoreMin.ToString();
            this.basePhredMaxValue.Text = stats.BasePhredScoreMax.ToString();
            this.basePhredMeanValue.Text = stats.BasePhredScoreMean.ToString();

            this.readPhredMinValue.Text = stats.ReadPhredScoreMin.ToString();
            this.readPhredMaxValue.Text = stats.ReadPhredScoreMax.ToString();
            this.readPhredMeanValue.Text = stats.ReadPhredScoreMean.ToString();
        }
